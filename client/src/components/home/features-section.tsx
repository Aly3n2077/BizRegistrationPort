  ...
  return (
    <section className="py-16 bg-primary-50">
      <div className="container mx-auto px-4 md:px-6">
        <h2 className="text-2xl md:text-3xl font-bold mb-12 text-primary-900 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="glassmorphism rounded-xl p-6">
              <div className="h-14 w-14 bg-primary-100 rounded-full flex items-center justify-center mb-4">
